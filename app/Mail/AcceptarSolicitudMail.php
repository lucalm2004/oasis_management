...
class AcceptarSolicitudMail extends Mailable
{
    ...
    public function build(){
        ...
        if ($rol == 3) {
            $estado = "Solicitud discoteca aceptada";
        } else if ($rol == 4) {
            $estado = "Solicitud de trabajo aceptada";
        }
        
        return $this->subject($estado)->view('mail.aceptarsolicitud');
    }
