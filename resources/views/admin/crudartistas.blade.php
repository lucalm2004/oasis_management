...
<body>
  ...
  <div class="container">
    <button class="btn-success" id="crearArtista"><i class="fa-solid fa-plus" style="color: #ffffff; "></i></button>
  ...
  <script src="{{ asset('js/adminArtistas.js') }}"></script>
