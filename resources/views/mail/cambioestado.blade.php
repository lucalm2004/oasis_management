 ...
 <body style="background-color: #10101a; font-family: 'Open Sans', sans-serif; font-optical-sizing: auto; font-style: normal; font-variation-settings: 'wdth' 100; margin: 0; padding: 0;">
     ...
     <div class="contenido" style=" padding: 4%; padding-top: 2%; margin-top: 2%; text-align: justify; background-color: white; margin-right: 2%; margin-left: 2%; border-radius: 5px; z-index: 99999;">
         ...
         @if ($user_correo->habilitado == 1)
         <p style="text-align: justify; color: black">Tu cuenta ha sido habilitada en Oasis. ¡Ahora puedes acceder a todos nuestros servicios y funcionalidades!</p>
        @else
            <p style="text-align: justify; color: black">Tu cuenta ha sido deshabilitada en Oasis. Si crees que esto ha sido un error, por favor contáctanos para resolver la situación.</p>
        @endif
