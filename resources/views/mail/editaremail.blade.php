...
<body style="background-color: #10101a; font-family: 'Open Sans', sans-serif; font-optical-sizing: auto; font-style: normal; font-variation-settings: 'wdth' 100; margin: 0; padding: 0;">
    ...
    <div class="contenido" style=" padding: 4%; padding-top: 2%; margin-top: 2%; text-align: justify; background-color: white; margin-right: 2%; margin-left: 2%; border-radius: 5px; z-index: 99999;">
        ...
        <p style="text-align: justify; color: black;">Han sido realizados los siguientes cambios en su cuenta:</p>
        <p style="text-align: justify; color: black">- Nombre: {{$user_correo->name}}</p>
        <p style="text-align: justify; color: black;">- Email: {{$user_correo->email}}</p>
        @if ($user_correo->DNI != null )
        <p style="text-align: justify; color: black;">- DNI: {{$user_correo->DNI}}</p>   
        @endif
        <p style="text-align: justify; color: black;">- Rol: {{$rol_correo->name}}</p>
        @if ($discoteca_correo != null)
        <p style="text-align: justify; color: black;">- Discoteca: {{$discoteca_correo->name}}</p>
        @endif
