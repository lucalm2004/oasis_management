...
<body style="background-color: #10101a; font-family: 'Open Sans', sans-serif; font-optical-sizing: auto; font-style: normal; font-variation-settings: 'wdth' 100; margin: 0; padding: 0;">
    ...
    <div class="contenido" style=" padding: 4%; padding-top: 2%; margin-top: 2%; text-align: justify; background-color: white; margin-right: 2%; margin-left: 2%; border-radius: 5px; z-index: 99999;">
        ...
        <p style="text-align: justify; color: black">Su solicitud de registar el club {{$discoteca_correo->name}} en Oasis, ha sido rechazada. Lo sentimos mucho, reintentelo de nuevo más tarde.</p>
       @else
           <p style="text-align: justify; color: black">Su solicitud de demanda de empleo en el club {{$discoteca_correo->name}}, ha sido aceptada. Lo sentimos mucho, reintentelo de nuevo más tarde.</p>
       @endif
