...
<body style="background-color: #10101a; font-family: 'Open Sans', sans-serif; font-optical-sizing: auto; font-style: normal; font-variation-settings: 'wdth' 100; margin: 0; padding: 0;">
    ...
    <div class="contenido" style=" padding: 4%; padding-top: 2%; margin-top: 2%; text-align: justify; background-color: white; margin-right: 2%; margin-left: 2%; border-radius: 5px; z-index: 99999;">
        <h1 style="font-size: 50px; text-align: center; color: black">Hola, <?php use Illuminate\Support\Facades\Auth;             $user = Auth::user();            echo $user->name;?>!</h1>
        <p style="text-align: justify; color: black">Gracias por su compra y por haver utilizado nuestra plataforma. ¡Espero que este satisfecho y le volvamos a ver proximamente!</p>
           <p style="text-align: justify; color: black">Adjunto encontrarás tu ticket para el evento .</p>
