...
<body>
    ...
    <div class="container mt-5">
        <div class="jumbotron">
            <div class="container">
                <h1 class="display-4">Valoración de Eventos</h1>
                <p class="lead">¡Valora los eventos de tus discotecas favoritas y comparte tus experiencias!</p>
                <hr class="my-4">
                <p class="lead">
                    <a class="btn btn-start btn-lg" href="#inicio" role="button">Comienza Ahora</a>
                </p>
            </div>
        </div>
        <div class="container mt-5">
            <h1 id='inicio'>Usuarios con Mejor Valoración</h1>
            <button onclick="toggleTopRatedUsers()" class="btn-primary mt-3">
                Ver Reseñas de Eventos
            </button>
        ...
        <div class="row mt-4">
            @foreach ($discotecas as $discoteca)
                <div class="col-lg-4 col-md-6 mb-4">
                    <!-- Ajusta las clases col-lg-4 y col-md-6 -->
                    <div class="card">
                        <img src="{{ asset('img/discotecas/' . $discoteca->image) }}" class="card-img-top"
                            alt="{{ $discoteca->name }}">
                        <div class="card-body">
                            ...
                            <button onclick="showEventsAndRate({{ $discoteca->id }})"
                                class="btn btn-primary mt-3">Valorar</button>
                            <button onclick="showReviews({{ $discoteca->id }})" class="btn btn-primary mt-3">Ver
                                Reseñas del Evento</button>
                        </div>
                    </div>
                </div>
            @endforeach
    ...
    <script>
        function submitRating(eventId, discotecaId) {
            ...
            const stars = starsContainer.querySelectorAll('.fas').length; // Contar las estrellas seleccionadas
