    ...
    <div class="container">
        <div class="row align-items">
            <div class="col-md-6 text text-md-left"> 
                ...
                <a class="btn btn-primary animate__animated animate__fadeInLeft" href="{{ route('login') }}"><i class="fas fa-user"></i> Iniciar Sesión</a>
            </div>
...
<section class="full-width-section py-5 animate__animated animate__delay-1s">
    <div class="container-fluid"> <!-- Usar container-fluid para ocupar todo el ancho -->
        <div class="row justify-content-center"> <!-- Centrar el contenido horizontalmente -->
            <div class="col-md-9 col-lg-7 animated"> <!-- Ajustar el tamaño de la columna para diferentes tamaños de pantalla -->
                <div class="content-box text-center">
                    <!-- Verifica la ruta y la extensión de la imagen -->
                    <img src="/img/gente.avif" class="img-fluid mb-4" alt="Imagen 4"> 
                    <h2 class="h2 mb-4"><i class="fas fa-glass-cheers"></i> Descubre el mejor entretenimiento nocturno</h2>
                    <p class="lead mb-4">Explora los eventos nocturnos más destacados cerca de ti.</p>
                    <p class="lead mb-4">Reserva fácilmente entradas, interactúa con otros asistentes a través del chat y disfruta de bonificaciones exclusivas.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (valorarBtn) {
                valorarBtn.addEventListener('click', function () {
                    ...
                    const authenticated = @json(auth()->check()); // Esto asume que estás usando Laravel y Blade
